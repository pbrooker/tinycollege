...
namespace MyTinyCollege.Helpers
{
    public class ImageUpload
    {
        ...
        private readonly string UploadPath = "~/DeptPics/";

        public bool DeleteImage(string name)
        {
            //string fileToDelete = UploadPath + name;
            var path = Path.Combine(HttpContext.Current.Request.MapPath(UploadPath), name);
        ...
        public ImageResult RenameUploadFile(HttpPostedFileBase file, string name)
        {
