...
{
    public class SchoolContext:DbContext  //need to inherit db context for constructor
    {
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
             ...
             * override the names we will get mappings such as InstructorInstructorID for the 
             * InstructorID column
             */
            ...
            //CourseInstructor with 2 FK Columns, CourseID, and InstructorID
            //CourseID -> Course
